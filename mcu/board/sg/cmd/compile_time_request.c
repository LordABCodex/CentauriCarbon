...
void ctr_run_shutdownfuncs(void)
{
    ...
    hx711s_shutdown();
    extern void hx711_sample_shutdown(void);
    hx711_sample_shutdown();
...
void ctr_run_taskfuncs(void)
{
    ...
    hx711s_task();
    irq_poll();
    extern void hx711_sample_task(void);
    hx711_sample_task();
    irq_poll();
...
ctr_lookup_static_string(const char *str)
{
    ...
    if (__builtin_strcmp(str, "Invalid spi bus") == 0)
        return 45;
    if (__builtin_strcmp(str, "reset") == 0)
        return 46;
...
static const uint8_t command_parameters50[] PROGMEM = {
    PT_byte, PT_byte, PT_uint32, PT_uint32, PT_uint32, PT_uint32, PT_uint32};
static const uint8_t command_parameters51[] PROGMEM = {
    PT_byte, PT_byte, PT_byte, PT_uint16, PT_uint32};
static const uint8_t command_parameters52[] PROGMEM = {
    PT_byte, PT_int32, PT_int32, PT_int32, PT_int32};
static const uint8_t command_parameters53[] PROGMEM = {
    PT_byte, PT_byte, PT_byte, PT_uint32, PT_uint32, PT_uint32};
static const uint8_t command_parameters54[] PROGMEM = {
    PT_byte, PT_byte, PT_uint32, PT_uint32, PT_uint32, PT_uint32, PT_uint32, PT_uint32};
static const uint8_t command_parameters55[] PROGMEM = {
    PT_byte, PT_byte, PT_uint32, PT_uint32, PT_uint32, PT_uint32, PT_uint32, PT_uint32, PT_uint32};
...
const struct command_encoder command_encoder_101 PROGMEM = {
    // sg_resp oid=%c vd=%c it=%c nt=%u r=%u tt=%u
    .msg_id = 101,
    .num_params = 6,
    .param_types = command_parameters53,
    .max_size = 64,
};
// const struct command_encoder command_encoder_102 PROGMEM = {
//     // debug_hx711_sample oid=%c arg[0]=%u arg[1]=%u arg[2]=%u arg[3]=%u
//     .msg_id = 102,
//     .num_params = 5,
//     .param_types = command_parameters34,
//     .max_size = 28,
...
ctr_lookup_encoder(const char *str)
{
    ...
    if (__builtin_strcmp(str, "sg_resp oid=%c vd=%c it=%c nt=%u r=%u tt=%u") == 0)
        return &command_encoder_101;
    // if (__builtin_strcmp(str, "debug_hx711_sample oid=%c arg[0]=%u arg[1]=%u arg[2]=%u arg[3]=%u") == 0)
...
extern void command_config_hx711_sample(uint32_t *);
extern void command_add_hx711_sample(uint32_t *);
extern void command_calibration_sample(uint32_t *);
extern void command_sg_probe_check(uint32_t *);
...
const struct command_parser command_index[] PROGMEM = {
    ...
    {// config_hx711s oid=%c hx711_count=%c channels=%u rest_ticks=%u kalman_q=%u kalman_r=%u max_th=%u min_th=%u k=%u
     .msg_id = 107,
     .num_params = 9,
     .param_types = command_parameters55,
     .num_args = 9,
     .flags = 0,
    ...
    {// config_hx711_sample oid=%c hx711_count=%c kalman_q=%u kalman_r=%u
     ...
     .num_args = 4,
     .flags = 0,
     .func = command_config_hx711_sample},
    ...
    {// calibration_sample oid=%c times_read=%hu
     ...
     .num_args = 2,
     .flags = 0,
     .func = command_calibration_sample},
    {// sg_probe_check oid=%c x=%i y=%i z=%i cmd=%i
     .msg_id = 113,
     .num_params = 5,
     .param_types = command_parameters52,
     .num_args = 5,
     .flags = 0,
     .func = command_sg_probe_check},
